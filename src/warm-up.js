...
var vegetables = ['cucumber', 'bell pepper', 'carrot', 'broccoli', 'corn'];
...
var fruits = ['strawberry', 'pineapple', 'pear', 'apple', 'grapes', 'mango', 'cherries'];
...
// keys: name, and isOpen. The value for name should be the string 'King Soopers' (or your favorite grocery store), and
